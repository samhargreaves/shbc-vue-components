        ...
        <ol v-else class="ml-3 border-l-2 border-primary">
            <li v-for="item in logs.data" :key="item.id">
                <div class="flex-start w-full md:flex">
                    ...
                    <div
                        class="mb-3 ml-2 block w-full rounded-lg bg-neutral-50 px-3 py-2 shadow-md shadow-black/5"
                    >
                        ...
                        >
                            ...
                            <span v-if="c.old" class="line-through">{{
                                c.old
                            }}</span>
                            {{ c.new }}
                        </p>
                        <p
                            v-if="item.description_details"
                            class="text-neutral-700"
                            v-html="item.description_details"
                        />
                    </div>
                </div>
            </li>
