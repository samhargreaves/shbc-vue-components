...
<template>
    <div
        class="mt-2 overflow-hidden rounded-lg border-2 border-gray-200 dark:border-gray-700"
        :class="{ 'px-4 py-2': !header }"
    >
        <div class="bg-white sm:rounded-lg" :class="{ 'p-1': !header }">
            <div
                ...
                tabindex="0"
                :aria-controls="
                    header ? header.replaceAll(' ', '_') : `collapsable`
                "
            >
                {{ header }}
                <button
            ...
            <div
                ...
                :id="header ? header.replaceAll(' ', '_') : `collapsable`"
                ref="collapseRef"
            >
