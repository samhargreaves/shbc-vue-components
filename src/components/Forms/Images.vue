...
<template>
    <form @submit.prevent="submit" class="w-full" v-if="canUpload">
        <div class="flex w-full">
            ...
            >
                <div
                    class="p-4' font-medium flex h-20 w-full cursor-copy items-center justify-center"
                    v-bind="getRootProps()"
                >
                ...
                >
                    ...
                    >
                        <div
                            class="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 font-bold text-white"
                        >
                            -
                        </div>
                        <img
            ...
            <PrimaryButton
                class="inline rounded-l-none"
                :class="{ 'cursor-not-allowed': form.image.length == 0 }"
